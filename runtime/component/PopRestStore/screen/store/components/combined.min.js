...
EmptyComponent:Vue.extend({template:'\x3cdiv\x3e\x3cdiv class\x3d"spinner"\x3e\x3cdiv\x3eLoading…\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e'}),LruMap:function(a){this.limit=a;this.valueMap={};this.lruList=[];this.put=function(a,c){var d=this.lruList,e=this.valueMap;e[a]=c;for(this._keyUsed(a);d.length>this.limit;){var f=d.pop();e[f]=null}};this.get=function(a){var c=this.valueMap[a];c&&this._keyUsed(a);return c};this.containsKey=function(a){return!!this.valueMap[a]};this._keyUsed=function(a){for(var c=
